...
- Being kind and patient, especially with people who are new to reverse-engineering, Python, or
  self-hosting. A lot of people arrive here just wanting to see their own car's battery level.
...
- Publishing others' private information — such as a physical or email address, VIN, number plate,
  account credentials, or vehicle location — without their explicit permission.
- Other conduct which could reasonably be considered inappropriate in a professional setting.

## Project-specific expectations

This project reads a private vehicle API, so a few things matter more here than in a typical repo:
...
- **Be honest about accuracy.** Don't present a guess as a validated fact. If a byte offset or a
  figure is inferred rather than confirmed, say so. Overstated certainty here makes other people's
  dashboards lie to them.
...
code review — and also applies when an individual is officially representing the project in public
spaces.

## Reporting

If you experience or witness unacceptable behaviour, please report it privately to the maintainer
[@GodrezJr2](https://github.com/GodrezJr2). You can also
[report content to GitHub](https://github.com/contact/report-abuse) directly, which is the right
route if the maintainer is the problem.
...
2. **Warning** — a warning with consequences for continued behaviour. No interaction with the people
